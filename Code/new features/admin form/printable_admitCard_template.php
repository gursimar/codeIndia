		...
		<tr>
			<td>
				<table border="0" cellpadding="5" cellspacing="0" width="100%" summary="" class="text14black" bgcolor="#FFFFFF">
					...
					<tr><td colspan="2" align="center"><strong><big>Punjab Pollution Control Board</big></strong></td></tr>
					...
					<tr>
						<td colspan="2" align="center"><input name="btnPrint" id="btnPrint" class="flat" type="button" value="Print" onclick="javascript: printIt()"></td>
					</tr>
					<tr>
						<td width="10%">&nbsp;</td>
						<td>&nbsp;</td>
