...
$upload_dir = "../../images/history"; 				// The directory for the images to be saved in
$upload_path = $upload_dir."/";				// The path to where the image will be saved
$large_image_prefix = "resize_"; 			// The prefix name to large image
$thumb_image_prefix = "history_";			// The prefix name to the thumb image
...
if (file_exists($large_image_location)){
	if(file_exists($thumb_image_location)){
		...
		$result = mysql_query("insert into Images(Image_Path,Location,Visibility) values('".substr($upload_path,6).$thumb_image_name.$_SESSION['user_file_ext']."','history','show')");
