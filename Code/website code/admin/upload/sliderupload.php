...
$upload_dir = "../../images/slider"; 				// The directory for the images to be saved in
$upload_path = $upload_dir."/";				// The path to where the image will be saved
$large_image_prefix = "resize_"; 			// The prefix name to large image
$thumb_image_prefix = "slider_";			// The prefix name to the thumb image
$large_image_name = $large_image_prefix.$_SESSION['random_key'];     // New name of the large image (append the timestamp to the filename)
$thumb_image_name = $thumb_image_prefix.$_SESSION['random_key'];     // New name of the thumbnail image (append the timestamp to the filename)
$max_file = "3"; 							// Maximum file size in MB
$max_width = "500";							// Max width allowed for the large image
$thumb_width = "618";						// Width of thumbnail image
$thumb_height = "246";						// Height of thumbnail image
...
if (file_exists($large_image_location)){
	if(file_exists($thumb_image_location)){
		...
		$result = mysql_query("insert into Images(Image_Path,Location,Visibility) values('".substr($upload_path,6).$thumb_image_name.$_SESSION['user_file_ext']."','slider','show')");
