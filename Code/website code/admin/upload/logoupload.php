...
$thumb_image_prefix = "logo";			// The prefix name to the thumb image
...
$query="insert into College_Info(Logo_Path) values('".substr($upload_path,6).$thumb_image_name.$_SESSION['user_file_ext']."')";
}else{
$query="UPDATE College_Info SET Logo_Path='".substr($upload_path,6).$thumb_image_name.$_SESSION['user_file_ext']."'";
}
mysql_query($query);
