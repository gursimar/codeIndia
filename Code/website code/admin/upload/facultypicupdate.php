...
if($_REQUEST['facid']!=null){
$_SESSION['facid']=$_REQUEST['facid'];
}
...
$row=mysql_result(mysql_query("select Faculty_Image_Path from Faculty_Details where Faculty_Id=".$_SESSION['facid']),0);
         unlink("../../".$row[0]);
		$result = mysql_query("Update Faculty_Details set Faculty_Image_Path='".substr($upload_path,6).$thumb_image_name.$_SESSION['user_file_ext']."' where Faculty_Id=".$_SESSION['facid']);
