...
mysql_query("update Images set Visibility='show' where id in ($sel) and Location='achieverGallery'");
mysql_query("update Images set Visibility='hide' where id not in ($sel) and Location='achieverGallery'");
}
