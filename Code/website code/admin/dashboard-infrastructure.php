...
<div id="workarea">
<?php include 'include/infrastructureLeftNav.php';?>
<div id="rightPane">
<div id="rightHead">INFRASTRUCTURE<span><?php $row=mysql_fetch_assoc(mysql_query("SELECT * from College_Info")); echo $row['College_Domain'];?>/infrastructure.php</span></div>
...
<form method="post" action="update/updateInfrastructure.php">

<div id="aboutRightText">Infrastructure Page Content:
...
?></textarea>
<input type="hidden" name="updateInfrastructure" value="true"/>
...
<div id="rightImage">Choose images for Infrastructure page:
<div id="imageMain">
...
<div id="imageSelect">
<?php
$result = mysql_query("select * from Images where Location='infrastructure'");
...
<form action="upload/infrastructureupload.php"  name="photo" enctype="multipart/form-data"  method="post">
