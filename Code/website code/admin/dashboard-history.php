...
<div id="workarea">
<?php include 'include/historyLeftNav.php';?>
<div id="rightPane">
<div id="rightHead">HISTORY<span><?php $row=mysql_fetch_assoc(mysql_query("SELECT * from College_Info")); echo $row['College_Domain'];?>/history.php</span></div>
...
<form method="post" action="update/updateHistory.php">

<div id="aboutRightText">History Page Content:
<div id="aboutTextMain">
<div id= "editor" >
<input type="hidden" name="homepage_mainpane" value="true"/>
    <textarea name="content" style="width:100%"><?php
$row=mysql_fetch_assoc(mysql_query("SELECT History from College_Info"));
echo $row[History];
?></textarea>
<input type="hidden" name="updateHistory" value="true"/>
...
<div id="rightImage">Choose images for history page:
<div id="imageMain">
...
<div id="imageSelect">
<?php
$result = mysql_query("select * from Images where Location='history'");
...
<form action="upload/historyupload.php"  name="photo" enctype="multipart/form-data"  method="post">
