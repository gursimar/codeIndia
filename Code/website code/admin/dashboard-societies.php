...
<div id="workarea">
<?php include 'include/societiesLeftNav.php';?>
<div id="rightPane">
<div id="rightHead">SOCIETIES<span><?php $row=mysql_fetch_assoc(mysql_query("SELECT * from College_Info")); echo $row['College_Domain'];?>/societies.php</span></div>
...
<form method="post" action="update/updateSocieties.php">

<div id="rightText">Societies Content:
<div id="textMain">
<div id= "editor" >
